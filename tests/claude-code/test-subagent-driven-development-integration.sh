...
mkdir -p src test docs/cadence/plans

# Create a simple implementation plan
cat > docs/cadence/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/cadence/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from cadence directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/cadence/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"cadence:subagent-driven-development"' "$SESSION_FILE"; then
